      ...
      >
        {gridState.map((cellValue, index) => (
          <input
            ...
            maxLength={3}
            className="w-full h-full bg-white dark:bg-slate-700 text-gray-800 dark:text-gray-200 text-center text-sm p-0 border-r border-b border-gray-400 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:z-10"
          />
        ))}
      </div>
    </section>
