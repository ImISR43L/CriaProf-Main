...
-- Tabela 2.4: template_answer_options (para templates)
...
-- ========= PASSO 3: HABILITAR RLS E DEFINIR POLÍTICAS DE ACESSO =========
...
-- Políticas para "template_answer_options"
...
-- O resto do seu arquivo Database.sql (criação de profiles, quizzes, templates, gatilhos, etc.) pode permanecer como estava.
-- Este script foca-se apenas na refatoração da estrutura das perguntas.